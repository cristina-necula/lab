...
_genericMenu.push(["New class diagram",
    function (a) {
...
_specificMenu.UMLClassDiagram = [
    ["ClassFlooder",
        //aici e clasa creata de mine
        function(b,a,d) {
            // b e obiectul in care deseneaza?
            // a si d sunt coordonatele de unde incepe sa deseneze
            ...
            //creaza primul element -> catre care sunt facute toate legaturile
            b.addElement(c);
            c.addAttribute("atr1");
            c.addAttribute("atr2");
            c.addOperation("construct()");
            c.addOperation("getAtr1()");
            c.addOperation("setAtr1()");
            c.addOperation("getAtr2()");
            c.addOperation("setAtr2()");
            c.addOperation("destroy()");
            // creeaza 150 de obiecte
            for(count = 1; count<=150;count++){
            // creeaza noul obiect diagrama
            var c = new UMLClass({
                x: xpos,
                y: ypos,
                stereotypes: _stereotypes
            });
            // adauga element in canvas
            b.addElement(c);
             // adauga atribute si operatii
            c.addAttribute("atr1");
            c.addAttribute("atr2");
            c.addOperation("construct()");
            c.addOperation("getAtr1()");
            ...
            c.addOperation("destroy()");
            //adauga relatiile
            b.addRelationFromPoints(new UMLAssociation(), a, d, xpos, ypos);
            // le afiseaza una langa alta pana cand e cazul sa treaca pe un rand nou
                if(xpos + 70 > 650)
                {
                    xpos =0;
                    ypos +=50;
...
_genericMenu.push(["New use case diagram",
    function (a) {
...
_genericMenu.push(["New component diagram",
    function (a) {
...
_genericMenu.push(["New sequence diagram",
    function (a) {
...
_genericMenu.push(["New state machine diagram",
    function (a) {
...
_genericMenu.push(["New activity diagram",
    function (a) {
...
_specificMenu.UMLActivityDiagram = [
    ...
    ["HorizontalHierarchicalSwimlane",
        function (b, a, d) {
